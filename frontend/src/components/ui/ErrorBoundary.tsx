    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex min-h-[400px] flex-col items-center justify-center px-4 text-center">
          ...
          <h2 className="mb-2 text-xl font-semibold text-slate-900">Bir hata oluştu</h2>
          ...
          <details className="mb-6 w-full max-w-lg text-left">
            ...
            <pre className="mt-2 max-h-40 overflow-auto rounded-lg bg-slate-100 p-3 text-xs text-red-600 whitespace-pre-wrap break-all">
              {errorMessage}
              {errorStack && `\n\n${errorStack}`}
            </pre>
          </details>
