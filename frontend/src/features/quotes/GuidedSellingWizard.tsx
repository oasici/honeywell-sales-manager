    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-4xl rounded-xl bg-white shadow-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          <h2 className="text-lg font-semibold text-gray-900">Rehberli Satis Sihirbazi</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {phase === 'select-guide' && (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">Bir satis rehberi secin:</p>
              {isLoadingGuides && (
                <div className="py-8 text-center text-sm text-gray-400">Yukleniyor...</div>
              )}
              {!isLoadingGuides && guides.length === 0 && (
                <div className="py-8 text-center text-sm text-gray-400">
                  Henuz rehber tanimlanmamis
                </div>
              )}
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {isLastStep ? 'Sonuclari Gor' : 'Ileri'}
                  </Button>
                </div>
              </div>
              ...
              <div className="w-72 shrink-0 space-y-3">
                <h4 className="text-sm font-semibold text-gray-700">Onerilen Urunler</h4>
                ...
                {suggestions &&
                  ...
                  suggestions.suggested_bundles.length === 0 && (
                    <p className="text-xs text-gray-400">Henuz oneri yok</p>
                  )}
          ...
          {phase === 'results' && (
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-gray-900">Sonuclar</h3>
              <p className="text-sm text-gray-500">
                Secimlerinize gore {suggestions?.match_count || 0} urun onerildi.
              </p>

              {suggestions && suggestions.suggested_parts.length > 0 && (
                <Card title="Onerilen Parcalar">
