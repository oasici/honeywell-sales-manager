...
@router.post("/customers/{customer_id}/team", status_code=201, response_model=GenericDataResponse)
...
@router.post("/sharing-rules/", status_code=201, response_model=GenericDataResponse)
